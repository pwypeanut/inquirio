...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'inquire_question', 'text', self.gf('django.db.models.fields.CharField')(max_length=500))
        db.add_column(u'inquire_question', 'subtopic',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['inquire.Subtopic']),
                      keep_default=False)
    def backwards(self, orm):

        # Changing field 'Question.text'
        db.alter_column(u'inquire_question', 'text', self.gf('django.db.models.fields.CharField')(max_length=512))
