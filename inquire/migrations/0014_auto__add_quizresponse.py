...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'inquire_quizresponse', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('quiz', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inquire.Quiz'])),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inquire.Question'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('chosen_answer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inquire.QuestionOption'])),
        ))
        db.send_create_signal(u'inquire', ['QuizResponse'])


    def backwards(self, orm):
        # Deleting model 'QuizResponse'
        db.delete_table(u'inquire_quizresponse')
    ...
    models = {
        ...
        u'inquire.question': {
            ...
            'unique_identifier': ('django.db.models.fields.CharField', [], {'default': "'9I1RAOAOHVO53I14P1SZJDGTJLTB6UCM'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'inquire.quiz': {
            ...
            'url': ('django.db.models.fields.CharField', [], {'default': "'NMW631'", 'max_length': '6'})
        },
        u'inquire.quizresponse': {
            'Meta': {'object_name': 'QuizResponse'},
            'chosen_answer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['inquire.QuestionOption']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'question': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['inquire.Question']"}),
            'quiz': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['inquire.Quiz']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'inquire.subtopic': {
