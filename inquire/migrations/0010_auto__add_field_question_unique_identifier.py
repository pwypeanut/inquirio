...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.unique_identifier'
        db.add_column(u'inquire_question', 'unique_identifier',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.unique_identifier'
        db.delete_column(u'inquire_question', 'unique_identifier')
    ...
    models = {
        ...
        u'inquire.question': {
            ...
            'unique_identifier': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
