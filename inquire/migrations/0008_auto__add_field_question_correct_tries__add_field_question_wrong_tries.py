...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.correct_tries'
        db.add_column(u'inquire_question', 'correct_tries',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Question.wrong_tries'
        db.add_column(u'inquire_question', 'wrong_tries',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.correct_tries'
        db.delete_column(u'inquire_question', 'correct_tries')

        # Deleting field 'Question.wrong_tries'
        db.delete_column(u'inquire_question', 'wrong_tries')
