...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quiz.url'
        db.add_column(u'inquire_quiz', 'url',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Quiz.url'
        db.delete_column(u'inquire_quiz', 'url')
    ...
    models = {
        ...
        u'inquire.question': {
            ...
            'unique_identifier': ('django.db.models.fields.CharField', [], {'default': "'R1YJJDGWHXUTETN9B2BSVIXTE0KG6J6X'", 'unique': 'True', 'max_length': '32'}),
        ...
        u'inquire.quiz': {
            ...
            'url': ('django.db.models.fields.CharField', [], {'max_length': '6'})
        },
        u'inquire.subtopic': {
