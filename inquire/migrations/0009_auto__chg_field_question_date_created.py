...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Question.date_created'
        db.alter_column(u'inquire_question', 'date_created', self.gf('django.db.models.fields.DateField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'Question.date_created'
        db.alter_column(u'inquire_question', 'date_created', self.gf('django.db.models.fields.DateField')())
